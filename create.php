...
<?php 
include_once 'head_comp.php';
include_once 'engine/db_core.php';
$myquery = 'SELECT `location_id`, `city`, `zip`, `address` FROM location';
 ...
 <!-- LOCATION FORM -->
	<form id="location_form" action="media_form/push.php" method="POST" class="container w-50 mt-5 text-center  allforms">
 ...
 <!-- Restaurant FORM -->
	<form id="restaurant" action="media_form/push.php" method="POST" class="container w-50 mt-5 text-center allforms">
 ...
 <!-- Things to do FORM -->
 		...
 		<form id="todo" action="media_form/push.php" method="POST" class="container w-50 mt-5 text-center allforms">
 ...
 <!-- Concerts FORM -->				
	...
	<form id="concert" action="media_form/push.php" method="POST" class="container w-50 mt-5 text-center allforms">
