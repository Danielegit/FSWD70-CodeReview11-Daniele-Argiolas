...
<div class="search-box container w-100">
		...
		<div id="btn" class="mt-2 mb-5">
       		 <button class="btn bg-danger text-white w-100">RESET</button>
        </div>
  

        <div class="container row d-flex justify-content-around" id="myrow"> </div>
      
        <div class="container row d-flex justify-content-around" id="myrow_c"> </div>
     
        <div class="container row d-flex justify-content-around" id="myrow_todo"> </div>
